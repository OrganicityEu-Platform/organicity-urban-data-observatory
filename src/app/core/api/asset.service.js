    ...
    asset.$inject = ['assetsAPI', '$window', 'timeUtils', '$filter', '$q'];
      ...
      function getClusterGeoJSON() {
            ...
            */
            ...
            ['55.93270000', '-2.98140000', 'Edinburgh'],  // Edinburgh
            ['50.87947200', '4.701072000', 'Leuven'],     // Leuven
            ['-9.13346700', '38.71400600', 'Lisbon'],     // Lisbon
            ['19.83354900', '45.26713600', 'NoviSad'],    // Novisad
